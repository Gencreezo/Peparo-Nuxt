<template>
  <v-form ref="characterDetails" v-model="valid" lazy-validation>
    <v-text-field
      v-model="title"
      label="Name"
      :rules="[
...
<script>
  ...
  export default {
    ...
    computed: {
      ...
      title: {
        get() {
          return this.getCharacter(this.currentTabObject.id).title;
        },
        set(title) {
          this.setCharacterTitle({
      ...
      profession: {
        get() {
          return this.getCharacter(this.currentTabObject.id).profession;
        },
        set(profession) {
          this.setCharacterProfession({
            id: this.currentTabObject.id,
      ...
      image: {
        get() {
          return this.getCharacter(this.currentTabObject.id).image;
        },
        set(image) {
      ...
      attributes() {
        return this.getCharacter(this.currentTabObject.id).attributes;
      },
      skills() {
        return this.getCharacter(this.currentTabObject.id).skills;
      },
    },
    methods: {
      ...mapMutations("adventureData", [
        ...
        "setCharacterImage",
        "setCharacterAttributeText",
        "setCharacterAttributeValue",
        "setCharacterSkillText",
        "setCharacterSkillValue",
      ...
      validate() {
        return this.$refs.characterDetails.validate();
      },
      // Attribute mutations
      setAttributeText(text, attrIndex) {
        this.setCharacterAttributeText({
          id: this.currentTabObject.id,
          attrIndex: attrIndex,
          text: text,
        });
      ...
      setAttributeValue(value, attrIndex) {
        this.setCharacterAttributeValue({
          id: this.currentTabObject.id,
          attrIndex: attrIndex,
          value: value,
        });
      ...
      pushAttribute() {
        this.addCharacterAttribute(this.currentTabObject.id);
      },
      spliceAttribute(i) {
        this.removeCharacterAttribute({
          id: this.currentTabObject.id,
          attributeIndex: i,
        });
      },
      ...
      pushSkill() {
        this.addCharacterSkill(this.currentTabObject.id);
      },
      spliceSkill(i) {
        this.removeCharacterSkill({
          id: this.currentTabObject.id,
          skillIndex: i,
        });
      },
